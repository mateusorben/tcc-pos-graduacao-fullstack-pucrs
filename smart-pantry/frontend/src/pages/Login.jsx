...
import { Mail, Lock, LogIn, ArrowRight, CheckCircle2, XCircle, Eye, EyeOff } from 'lucide-react';
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="Senha"
                className="w-full pl-10 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                value={password}
